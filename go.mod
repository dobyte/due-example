...
require (
	...
	github.com/dobyte/due/locate/redis v0.0.8
	github.com/dobyte/due/network/ws v0.0.8
	github.com/dobyte/due/registry/etcd v0.0.8
	github.com/dobyte/due/transport/rpcx v0.0.8
